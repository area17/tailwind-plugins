...
<div class="copy rich-text">
  ...
  <figure class="code-example">
    ...
    <pre class="code-example-code"><code class="language-javascript">const { Components } = require('@area17/a17-tailwind-plugins');
...
module.exports = {
  ...
  <p><code>theme.components</code> is essentially a object of <code>selectors</code>. Each entry can either be set to a string of classes to <code>@apply</code>, or an object containing <code>apply</code>, <code>attributes</code>, <code>selectors</code>, <code>breakpoints</code> and <code>variants</code> keys:</p>
  ...
  <p>Every child selector can also be set to a string of classes to <code>@apply</code>, or an object containing <code>apply</code>, <code>attributes</code>, <code>selectors</code>, <code>breakpoints</code> and <code>variants</code> keys.</p>

  <p>Comma separated values and psuedo selectors will also be correctly parsed:</p>

  <figure class="code-example">
    <figcaption class="code-example-filename">tailwind.config.js</figcaption>
    <pre class="code-example-code"><code class="language-javascript">components: {
  ".rich-text, .wysiwyg": {
    selectors: {
      a: "text-accent underline",
...
.rich-text a:focus {
  ...
  <p>Your Tailwind build will error out if you <code>@apply</code> classes that aren't defined or if you use <code>@screen</code> with breakpoints that don't exist.</p>

  <p><strong>Note:</strong> this plugin doesn't attempt to validate your input.</p>
</div>
