<?php $title = 'Interaction Media Queries'; ?>
<?php include 'includes/_header.php'; ?>

<div class="copy">
  <h2 id="description">Description</h2>

  <p>Generates a series Tailwind media query classes to query a document based on the presence and accuracy of the user’s pointing device and whether it has the ability to hover over elements. For a better understanding, CSS Tricks has a great article about them: <a href="https://css-tricks.com/touch-devices-not-judged-size/" target="_blank">Touch Devices Should Not Be Judged By Their Size</a>.</p>

  <h2 id="setup">Setup</h2>

  <figure class="code-example">
    <figcaption class="code-example-filename">tailwind.config.js</figcaption>
    <pre class="code-example-code"><code class="language-javascript">const { InteractionMediaQueries } = require('@area17/a17-tailwind-plugins');
...
module.exports = {
  ...
  <p>This plugin will output prefix classes which generate media queries for:</p>

  <ul>
    <li><code>.pointer-course:foo</code> generates <code>@media (pointer: coarse){ ... }</code></li>
    <li><code>.pointer-fine:foo</code> generates <code>@media (pointer: fine){ ... }</code></li>
    <li><code>.pointer-none:foo</code> generates <code>@media (pointer: none){ ... }</code></li>
