...
<div class="copy">
  ...
  <ul>
    <li><code>.grid-layout</code> - on parent, makes css grid layout with columns set to equal the amount of design columns at each breakpoint and with the grid gap set to the inner gutter</li>
    <li class="mt-20"><code>.grid-col-span-N</code> - on child, sets width N grid columns wide</li>
    <li><code>.grid-col-start-N</code> - on child, starts element on the Nth grid column</li>
    <li><code>.grid-col-end-N</code> - on child, ends element on the Nth grid column</li>
  </ul>

  <h3>Why use this over Tailwind's native grid column classes?</h3>

  <p>By default, Tailwind assumes you have a 12 grid layout at all your breakpoints - this plugin does not. This plugin uses your Tailwind config, specifically the <code>Setup</code> <code>theme.columnCount</code> to adjust the amount of columns at each breakpoint so if your <code>md</code> breakpoint has 8 design columns, you can easily span 6 of them without having to convert from 12. This plugin also allows nesting whilst keeping to your overall amount of design columns.</p>

  <h2 id="setup">Setup</h2>

  <figure class="code-example">
    <figcaption class="code-example-filename">tailwind.config.js</figcaption>
    <pre class="code-example-code"><code class="language-javascript">const { Setup, GridLayout } = require('@area17/a17-tailwind-plugins');
...
module.exports = {
  ...
  <p>Requires <code>Setup</code> plugin with <code>theme.innerGutters</code> and <code>theme.columnCount</code> configured.</p>
...
<div class="copy">
  <figure class="code-example">
    ...
    <pre class="code-example-code"><code class="language-html">&lt;div class="grid-layout">
...
<div class="copy">
  <figure class="code-example">
    <figcaption class="code-example-filename">document.html</figcaption>
    <pre class="code-example-code"><code class="language-html">&lt;div class="grid-layout mt-40">
...
<div class="copy">
  <figure class="code-example">
    <figcaption class="code-example-filename">document.html</figcaption>
    <pre class="code-example-code"><code class="language-html">&lt;div class="cols-grid mt-40">
