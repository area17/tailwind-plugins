...
<div class="copy">
  ...
  <figure class="code-example">
    ...
    <pre class="code-example-code"><code class="language-javascript">const { Setup } = require('@area17/a17-tailwind-plugins');
...
@media (min-width: 1520px) {
  ...
  <p>Which means <code>Setup</code> is required for each of those.</p>
